...
# Redirect all stdout/stderr to out.txt in workspace root
out_path = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'out.txt'))
...
# Setup client
finnhub_client = finnhub.Client(api_key="d57g07pr01qrcrnbat0gd57g07pr01qrcrnbat10")
